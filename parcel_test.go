...
func TestGetByClient(t *testing.T) {
	...
	for _, parcel := range storedParcels {
		...
		expectParcel, exists := parcelMap[parcel.Number]
		require.True(t, exists)

		assert.Equal(t, expectParcel.Client, parcel.Client)
		assert.Equal(t, expectParcel.Status, parcel.Status)
		assert.Equal(t, expectParcel.Address, parcel.Address)
		assert.Equal(t, expectParcel.CreatedAt, parcel.CreatedAt)
